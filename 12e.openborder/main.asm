...
.label lastZP      = $f6
    ...
    *=spindleLoadAddress-18-9-3 "Spindle header"
    .label spindleHeaderStart = *
      ...
      .byte 'Z', <firstZP, <lastZP  // declare used 0 page adresses
      .byte 'I', >($2800), >($a000) // fake inherit previous memory to not load too much
      .byte 'I', >($e000), >($ffff) // fake inherit previous memory to not load too much
...
.var minPos    = $ff5800
.var Speed     = 0
.var centre    = (Position+minPos)/2
.var radius    = (Position-minPos)/2
.var frames    = 50
...
.var ramp = List().add($06,$0b,$04,$0e,$03,$0d,$01,$01,$01,$07,$03,$0a,$0c)
.var repeat = 3
